...
const Products = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (product) => (
        <span
          className={`status-badge ${product.status === "Buyable" ? "status-buyable" : "status-not-buyable"
            }`}
        >
          {product.status}
        </span>
    ...
    },
    {
      ...
      sortable: true,
      width: "60px",
      render: (product) => <span className="metric-value rq-value">{product.rq}</span>,
    },
    {
      key: "posCode",
      label: "POS CODE ⓘ",
      ...
      render: (product) =>
        product.posCode ? (
          <div className="pos-code-cell">
            ...
            <div className="pos-metrics">
              <span className="pos-metric success">MN:{product.posCode.mn}</span>
              <span className="pos-metric primary">MX:{product.posCode.mx}</span>
            </div>
          </div>
        ) : (
    ...
    },
    {
      ...
      render: () => (
        <div className="actions-cell">
          ...
          <button className="action-icon-btn" title="External Link">🔗</button>
          <button className="action-icon-btn" title="Add to Cart">🛒</button>
        </div>
      ),
    },
  ];
