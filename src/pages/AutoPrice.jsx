...
const AutoPrice = () => {
    ...
    const columns = [
            ...
            render: (row) => (
                <div className="brand-cell">
                    ...
                    <div className="rating">
                        <span className="star">⭐</span> {row.rating} • {row.reviews} reviews
                    </div>
                </div>
            ),
        },
        {
            ...
            render: (row) => (
                <div className="price-cell">
                    <div className="your-price">Your: <strong>R{row.yourPrice}</strong></div>
                    <div className="low-price">Low: {row.lowPrice ? `R${row.lowPrice}` : "-"}</div>
                </div>
            ),
        },
        {
            ...
            width: "100px",
            render: (row) => (
                <span className={row.priceDiff?.startsWith("+") ? "diff-positive" : "diff-neutral"}>
                    {row.priceDiff || "-"}
                </span>
            ),
        },
        {
            ...
            width: "100px",
            render: (row) => (
                <span className="win-price">{row.winPrice ? `R${row.winPrice}` : "-"}</span>
            ),
        },
        {
            key: "compStatus",
            ...
            width: "140px",
            render: (row) => (
                <span className="comp-status winning">
                    🏆 {row.compStatus}
                </span>
            ),
        },
